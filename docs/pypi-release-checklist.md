...
> **1.4.0 (2026-09-13): собрана, загрузка на PyPI ЖДЁТ ОПЕРАТОРА.** Накоплено
...
> инстанса не взаимозаменяемы — своп ловится). Версия — минор по правилу
> «новая проверка = минор». Артефакты: `verifier/dist/sia_verifier-1.4.0*`.
